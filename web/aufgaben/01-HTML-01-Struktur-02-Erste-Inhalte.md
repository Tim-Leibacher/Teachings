...
**Was du hinzufügen sollst:**

1. **Einen Titel für den Browser-Tab** im `<head>`:
   - Ändere den Titel so, dass er deinen echten Namen enthält
   - Beispiel: "Anna Schmidt - Angehende Informatikerin"

2. **Eine Hauptüberschrift** im `<body>`:
   - Nutze `<h1>` für deinen Namen
   - Beispiel: `<h1>Willkommen! Ich bin Max Mustermann</h1>`

3. **Ein kurzer Begrüssungstext**:
   - Schreibe 2-3 Sätze über dich in einem `<p>`-Tag
   - Beispiel: "Ich bin Lernende/r im 1. Lehrjahr als Informatiker/in EFZ. Auf dieser Seite zeige ich meine Projekte und Fortschritte."

**Beispielcode:**
```html
<body>
    <h1>Willkommen! Ich bin Dein Name</h1>
    <p>Ich bin Lernende/r im 1. Lehrjahr bei [Firma]. 
    Auf dieser Seite zeige ich meine Projekte und Fähigkeiten.</p>
</body>
```
...
- [ ] Der Begrüssungstext ist sichtbar und gut lesbar
...
- [MDN: Paragraphs](https://developer.mozilla.org/de/docs/Web/HTML/Element/p)

---

**⏱️ Geschätzte Zeit:** 20-25 Minuten  
**📦 Nächster Schritt:** In Auftrag 3 strukturierst du deine Seite mit Header, Main und Footer!
